...
export default function SearchPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-6xl">
      ...
      {/* Search Bar */}
      <div className="bg-white rounded-lg border-2 border-gray-200 p-6 mb-8 shadow-lg">
        <div className="relative mb-4">
          ...
          <input
            ...
            className="w-full pl-14 pr-4 py-4 text-lg border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            autoFocus
          />
        </div>
          ...
          <div className="space-y-4">
            {results.map((result) => (
              <Link
                ...
                className="block bg-white rounded-lg border border-gray-200 p-6 hover:border-blue-500 hover:shadow-lg transition-all"
              >
