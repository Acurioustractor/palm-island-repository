...
export default function StoriesGalleryPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Header */}
      <div
        className="bg-white border-b border-gray-100 py-16"
        style={heroImage ? {
      ...
      >
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-5xl md:text-6xl font-bold mb-4 text-gray-900">Community Stories</h1>
            ...
            <div className="mt-8 flex justify-center gap-4 flex-wrap">
              <Link
                href="/share-voice"
                className="bg-gray-900 text-white px-8 py-4 rounded-full font-semibold text-lg hover:bg-gray-800 transition-all focus:outline-none focus:ring-4 focus:ring-gray-900/20 flex items-center gap-2"
              >
              ...
              <Link
                ...
                className="border border-gray-200 hover:border-gray-900 text-gray-700 hover:text-gray-900 px-8 py-4 rounded-full font-medium text-lg transition-all flex items-center gap-2"
              >
              ...
              <Link
                href="/storytellers"
                className="border border-gray-200 hover:border-gray-900 text-gray-700 hover:text-gray-900 px-8 py-4 rounded-full font-medium text-lg transition-all"
              >
                View Storytellers
              </Link>
              <Link
      ...
      <div className="container mx-auto px-4 py-8">
            ...
            <div className="flex flex-col md:flex-row gap-4 mb-6">
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3 border-2 border-gray-200 rounded-full focus:border-gray-400 focus:outline-none transition-colors"
                />
              </div>
            </div>
              ...
              {filteredStories.map((story) => {
                ...
                return (
                  <Link
                    ...
                    className={`group bg-white rounded-2xl overflow-hidden hover:border-gray-900 transition-all border-2 ${colors.border}`}
                  >
                    ...
                    <div className="p-6">
                      ...
                      <div className="mt-4 text-gray-700 font-medium flex items-center">
        ...
        {/* CTA Section */}
        <div className="max-w-4xl mx-auto mt-12 bg-white border border-gray-100 rounded-2xl p-8 text-center">
          <h2 className="text-3xl font-bold mb-4 text-gray-900">Your Story Matters</h2>
          ...
          <Link
            href="/share-voice"
            className="inline-block bg-gray-900 text-white px-8 py-4 rounded-full font-semibold text-lg hover:bg-gray-800 transition-all focus:outline-none focus:ring-4 focus:ring-gray-900/20"
          >
