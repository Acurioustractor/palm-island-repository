...
const STOPS: Stop[] = [
  ...
  },
  {
    ...
    blurb: 'Pencil is the design source of truth for the print run. React-PDF handles rapid web drafts. Same Saltwater & Earth tokens flow through both — Pencil → tokens.json → lib/pdf/theme.ts.',
    stageNote: 'For print: Pencil exports the final PDF. For the web: React-PDF generates audience-targeted drafts. Two pipelines, one palette, same data.',
    publicUrl: '/picc/reports/builder',
    publicLabel: 'picc.studio/picc/reports/builder',
    pencilFile: 'picc-annual-report.pen',
    pencilFrame: '📄 Annual report · cover + spreads + back',
    elAdmin: [
      { label: 'Annual report data composer', href: '/picc/annual-report-data' },
      { label: 'Web draft (smaller PDFs work)', href: '/api/pdf/generate?type=stories' },
      { label: 'Plan: Pencil + React-PDF strategy', href: '/picc' },
    ],
    colour: SECTION_COLOURS.economic,
  },
  {
