...
const STOPS: Stop[] = [
  ...
  },
  {
    ...
    blurb: 'Designed in Pencil. Exported to PDF for print. The platform is the data source — Pencil is the layout. Same palette, tokens flow Pencil → tokens.json → web → print.',
    stageNote: 'The annual report is a Pencil document. The web shows the live data. The print is the moment the data gets bound between covers.',
    publicUrl: '/annual-reports',
    publicLabel: 'picc.studio/annual-reports',
    pencilFile: 'picc-annual-report.pen',
    pencilFrame: '📄 Cover · spreads · back',
    elAdmin: [
      { label: 'Annual report data composer (web view)', href: '/picc/annual-report-data' },
    ],
    colour: SECTION_COLOURS.economic,
  },
  {
