      ...
      {!file ? (
        ...
        >
          ...
          <div className="space-y-3">
            <div className="mx-auto w-12 h-12 rounded-full bg-warm-100 flex items-center justify-center">
              <svg className="w-6 h-6 text-picc-ochre" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex items-center justify-center gap-2 text-sm text-picc-ochre">
              ...
              {analysis.culturalElements.found && (
                <div className="p-3 bg-picc-ochre-50 border border-picc-ochre-200 rounded-lg">
                  <div className="flex items-start gap-2">
                    <svg className="w-5 h-5 text-picc-ochre flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                    </svg>
                    <div>
                      <p className="font-medium text-picc-ochre-800">Cultural Content Detected</p>
                      <p className="text-sm text-picc-ochre-700 mt-1">
                        {analysis.culturalElements.significance || 'This image may contain Indigenous cultural elements.'}
                      </p>
                      <ul className="mt-2 text-sm text-picc-ochre-700">
