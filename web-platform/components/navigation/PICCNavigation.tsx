...
const staffNavigation: { [key: string]: NavSection } = {
  ...
  reports: {
    ...
    items: [
      ...
      { label: '💬 Quote library', href: '/picc/almanac/quotes', icon: Quote, description: '148 EL quotes scored for annual-report use · filter by speaker · theme' },
      { label: '🔍 System audit', href: '/picc/almanac/system-audit', icon: AlertTriangle, description: "What's in EL but NOT in the 22-spread report · proposed extra spreads" },
