...
export default function ShareButtons({ url, title, description, compact }: ShareButtonsProps) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      ...
      <button
        onClick={handleCopy}
        className="inline-flex items-center gap-2 px-4 py-2 border border-gray-200 text-gray-700 rounded-full text-sm font-medium hover:bg-gray-50 transition-colors"
      >
        {copied ? (
          <>
