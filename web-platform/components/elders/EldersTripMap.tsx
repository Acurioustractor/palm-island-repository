          ...
          <div className="absolute left-4 bottom-4 right-4 md:right-auto md:w-[420px] bg-white/95 backdrop-blur rounded-xl border border-stone-200 shadow-xl p-4">
            <div className="flex items-start justify-between gap-3">
              <div className="min-w-0">
                <div className="text-xs font-semibold text-picc-ochre">Selected stop</div>
            ...
            <li key={s.id}>
              <button
                ...
                className={`w-full text-left rounded-xl border px-3 py-2 transition-colors ${
                  activeId === s.id ? 'bg-white border-picc-ochre-300' : 'bg-white/70 border-stone-200 hover:border-stone-300'
                }`}
              >
                <div className="flex items-center gap-2">
                  <div className="w-6 h-6 rounded-full bg-picc-ochre text-white text-xs font-bold flex items-center justify-center flex-shrink-0">
                    {idx + 1}
                  </div>
